    ...
    return (
        <div className="relative w-full h-full rounded-3xl overflow-hidden bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900/50 dark:to-slate-800/50 border border-slate-200 dark:border-slate-700 shadow-2xl">
            ...
            <div className="relative w-full h-full p-4 flex flex-col gap-3">
                {/* YAML Code Block */}
                <div className="relative bg-slate-900 rounded-xl border border-slate-700 shadow-xl overflow-hidden" style={{ height: '35%' }}>
  ...
  vm-web:
    ...
    dependsOn:
      - network`}</code>
                ...
                {/* Diagram */}
                <div className="relative flex-1 rounded-xl border border-slate-200 dark:border-slate-700 shadow-xl overflow-hidden" style={{ backgroundColor: '#0F172A' }}>
                    <div className="absolute top-2 left-3 z-10 flex items-center gap-2">
                        <div className="flex gap-1.5">
                            <div className="w-2.5 h-2.5 rounded-full bg-red-400" />
                            <div className="w-2.5 h-2.5 rounded-full bg-yellow-400" />
